	...
	private function get_notice($notice) {
		...
		$notices = array(
			'finish_install' => array(
				'level' => 'info',
				'msg'   => '<a href="' . get_admin_url(null, 'admin.php?page=mapsmarkerpro_license') . '"><img style="width: 50px; height: 50px; margin-right: 10px; vertical-align: middle;" src="' . plugins_url('images/logo-mapsmarker-pro.svg', MMP::$path) . '" />' . esc_html__('Please click here to finish the installation of Maps Marker Pro.', 'mmp') . '</a>'
			),
			'new_install' => array(
				'level' => 'info',
