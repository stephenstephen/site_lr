...
class Settings extends Menu {
	...
	public function get_custom_layers() {
		...
		if (!isset($_POST['nonce']) || wp_verify_nonce($_POST['nonce'], 'mmp-settings') === false) {
			return;
		}
	...
	protected function show() {
		...
		$mmp_settings = MMP::get_instance('MMP\Settings');
		$layers = MMP::get_instance('MMP\Layers');
		$upload = MMP::get_instance('MMP\Upload');
				...
				<div class="mmp-settings-wrap">
					...
					<div class="mmp-settings-tabs">
						...
						<div id="layers_google_tab" class="mmp-settings-tab">
							<h2>Google Maps</h2>
							<p>
								<a href="https://www.mapsmarker.com/google-maps-javascript-api/" target="_blank"><img src="<?= plugins_url('images/geocoding/google-maps-logo.png', MMP::$path) ?>" /></a><br />
						...
						<div id="layers_bing_tab" class="mmp-settings-tab">
							<h2>Bing Maps</h2>
							<p>
								<a href="https://www.mapsmarker.com/bing-maps/" target="_blank"><img src="<?= plugins_url('images/geocoding/bing-maps-logo.png', MMP::$path) ?>" /></a><br />
						...
						<div id="layers_here_tab" class="mmp-settings-tab">
							<h2>HERE Maps</h2>
							<p>
								<a href="https://www.mapsmarker.com/here-maps/" target="_blank"><img src="<?= plugins_url('images/geocoding/here-logo.png', MMP::$path) ?>" /></a><br />
						...
						<div id="layers_tom_tab" class="mmp-settings-tab">
							<h2>TomTom</h2>
							<p>
								<a href="https://www.mapsmarker.com/tomtom/" target="_blank"><img src="<?= plugins_url('images/geocoding/tomtom-logo.png', MMP::$path) ?>" /></a><br />
						...
						<div id="geocoding_provider_tab" class="mmp-settings-tab">
							...
							<div class="mmp-settings-setting">
								<div class="mmp-settings-desc"><?= esc_html__('Default geocoding provider', 'mmp') ?></div>
								<div class="mmp-settings-input">
									<ul>
						...
						<div id="geocoding_algolia_tab" class="mmp-settings-tab">
							...
							<p>
								<a href="https://www.mapsmarker.com/algolia-places/" target="_blank"><img src="<?= plugins_url('images/geocoding/algolia-places.png', MMP::$path) ?>" /></a><br />
						...
						<div id="geocoding_photon_tab" class="mmp-settings-tab">
							...
							<p>
								<a href="https://www.mapsmarker.com/photon/" target="_blank"><img src="<?= plugins_url('images/geocoding/photon-mapsmarker.png', MMP::$path) ?>" /></a><br />
							...
							<div class="mmp-settings-setting">
								...
								<div class="mmp-settings-input">
									<ul>
										<li><label><input type="radio" name="geocodingPhotonBounds" value="enabled" <?= $this->checked($settings['geocodingPhotonBounds'], true) ?> /> <?= esc_html__('enabled', 'mmp') ?></label></li>
										<li><label><input type="radio" name="geocodingPhotonBounds" value="disabled" <?= $this->checked($settings['geocodingPhotonBounds'], false) ?> /> <?= esc_html__('disabled', 'mmp') ?></label></li>
									</ul>
									<span class="mmp-settings-footnote">
							...
							<div class="mmp-settings-setting">
								...
								<div class="mmp-settings-input">
									<input type="text" name="geocodingPhotonBoundsLat1" placeholder="48.326583" value="<?= $settings['geocodingPhotonBoundsLat1'] ?>" />
								</div>
							</div>
							<div class="mmp-settings-setting">
								<div class="mmp-settings-desc"><?= esc_html__('Longitude', 'mmp') ?> 1</div>
								<div class="mmp-settings-input">
									<input type="text" name="geocodingPhotonBoundsLon1" placeholder="16.55056" value="<?= $settings['geocodingPhotonBoundsLon1'] ?>" />
								</div>
							</div>
							<div class="mmp-settings-setting">
								<div class="mmp-settings-desc"><?= esc_html__('Latitude', 'mmp') ?> 2</div>
								<div class="mmp-settings-input">
									<input type="text" name="geocodingPhotonBoundsLat2" placeholder="48.114308" value="<?= $settings['geocodingPhotonBoundsLat2'] ?>" />
								</div>
							</div>
							<div class="mmp-settings-setting">
								<div class="mmp-settings-desc"><?= esc_html__('Longitude', 'mmp') ?> 2</div>
								<div class="mmp-settings-input">
									<input type="text" name="geocodingPhotonBoundsLon2" placeholder="16.187325" value="<?= $settings['geocodingPhotonBoundsLon2'] ?>" />
								</div>
							</div>
						...
						<div id="geocoding_locationiq_tab" class="mmp-settings-tab">
							...
							<p>
								<a href="https://www.mapsmarker.com/locationiq-geocoding/" target="_blank"><img src="<?= plugins_url('images/geocoding/locationiq.png', MMP::$path) ?>" /></a>
							</p>
							<div class="mmp-settings-setting">
						...
						<div id="geocoding_mapquest_tab" class="mmp-settings-tab">
							<h2>MapQuest</h2>
							<p>
								<a href="https://www.mapsmarker.com/mapquest-geocoding/" target="_blank"><img src="<?= plugins_url('images/geocoding/mapquest-logo.png', MMP::$path) ?>" /></a><br />
						...
						<div id="geocoding_tomtom_tab" class="mmp-settings-tab">
							...
							<p>
								<a href="https://www.mapsmarker.com/tomtom-geocoding/" target="_blank"><img src="<?= plugins_url('images/geocoding/tomtom-logo.png', MMP::$path) ?>" /></a><br />
							...
							<div class="mmp-settings-setting">
								...
								<div class="mmp-settings-input">
									...
									<span class="mmp-settings-footnote">
										<?= sprintf(esc_html__('Changes the language of the results. You can pass IETF language tags (%1$s).', 'mmp'), '<a href="https://en.wikipedia.org/wiki/IETF_language_tag#Syntax_of_language_tags" target="_blank">IETF BCP 47</a>') ?><br />
										<?= esc_html__('If empty, the language set in WordPress will be used.', 'mmp') ?>
									</span>
								</div>
							</div>
							...
							<div class="mmp-settings-setting">
								...
								<div class="mmp-settings-input">
									...
									<span class="mmp-settings-footnote">
										...
										<img src="<?= plugins_url('images/options/backlink.jpg', MMP::$path) ?>" /><br />
										<img src="<?= plugins_url('images/options/backlink-kml.jpg', MMP::$path) ?>" />
									</span>
								</div>
							</div>
						</div>
						<div id="misc_icons_tab" class="mmp-settings-tab">
							...
							<div class="mmp-settings-setting">
								...
								<div class="mmp-settings-input">
									<ul>
										<li><label><input type="radio" name="iconCustomShadow" value="default" <?= $this->checked($settings['iconCustomShadow'], 'default') ?> /> <?= esc_html__('use default shadow', 'mmp') ?> (<?= esc_html__('preview', 'mmp') ?>: <img src="<?= plugins_url('images/leaflet/marker-shadow.png', MMP::$path) ?>" />)</label></li>
						...
						<div id="misc_wordpress_tab" class="mmp-settings-tab">
							...
							<div class="mmp-settings-setting">
								<div class="mmp-settings-desc"><?= esc_html__('Lazy loading', 'mmp') ?></div>
								<div class="mmp-settings-input">
									<ul>
										<li><label><input type="radio" name="lazyLoad" value="enabled" <?= $this->checked($settings['lazyLoad'], true) ?> /> <?= esc_html__('enabled', 'mmp') ?></label></li>
										<li><label><input type="radio" name="lazyLoad" value="disabled" <?= $this->checked($settings['lazyLoad'], false) ?> /> <?= esc_html__('disabled', 'mmp') ?></label></li>
									</ul>
									<span class="mmp-settings-footnote">
