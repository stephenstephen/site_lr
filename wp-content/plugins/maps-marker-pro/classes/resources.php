...
class Resources {
	...
	public function register_backend_resources() {
		...
		// wp_register_script('mmp-leaflet-geoman', plugins_url('js/leaflet-geoman.js', MMP::$path), array('mapsmarkerpro'), MMP::$version, true);
	...
	private function geocoding_settings() {
		...
		$settings = array(
			...
			'mapquest'        => array(
				...
				'footer'      => '<div class="ap-footer">' . $footer_tips . '<div style="float:right;"><a href="https://www.mapsmarker.com/mapquest-geocoding/" target="_blank"><img src="' . plugins_url('images/geocoding/mapquest-logo-small.png', MMP::$path) . '" width="144" height="26"/></a></div><div style="float:right;margin:6px 5px 0 0;"><a href="https://www.mapsmarker.com/mapquest-geocoding/" target="_blank">' . esc_html__('Powered by', 'mmp') . '</a></div></div>'
			),
			'google' => array(
				'nonce'  => wp_create_nonce('mmp-google-places'),
				'footer' => '<div class="ap-footer">' . $footer_tips . '<a href="https://www.mapsmarker.com/google-geocoding/" target="_blank"><img src="' . plugins_url('images/geocoding/powered-by-google.png', MMP::$path) . '" width="144" height="18" /></a></div>'
			),
			'tomtom' => array(
				...
				'footer'     => '<div class="ap-footer">' . $footer_tips . '<div style="float:right;"><a href="https://www.mapsmarker.com/tomtom-geocoding/" target="_blank"><img src="' . plugins_url('images/geocoding/tomtom-logo.png', MMP::$path) . '" width="99" height="26"/></a></div><div style="float:right;margin:6px 5px 0 0;"><a href="https://www.mapsmarker.com/tomtom-geocoding/" target="_blank">' . esc_html__('Powered by', 'mmp') . '</a></div></div>'
			),
