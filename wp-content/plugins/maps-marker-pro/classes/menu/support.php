	...
	protected function show() {
		...
		<div class="wrap mmp-wrap">
			...
			<div class="mmp-main">
				...
				<h2><?= esc_html__('Database API', 'mmp') ?></h2>
				<p>
					<?= esc_html__('The Database API provides developers with a future-proof way to access or modify the Maps Marker Pro database programatically.', 'mmp') ?><br />
					<?= sprintf(esc_html__('For full documentation and usage examples, please visit %1$s.', 'mmp'), '<a href="https://www.mapsmarker.com/database-api/" target="_blank">https://www.mapsmarker.com/database-api/</a>') ?>
				</p>
				<h2><?= esc_html__('Shortcode API', 'mmp') ?></h2>
				<p>
					<?= esc_html__('Use the Shortcode API to create maps dynamically, without adding them on the backend first, or to override the map settings.', 'mmp') ?><br />
					<?= sprintf(esc_html__('For full documentation and usage examples, please visit %1$s.', 'mmp'), '<a href="https://www.mapsmarker.com/shortcodes/" target="_blank">https://www.mapsmarker.com/shortcodes/</a>') ?>
				</p>
				<h2><?= esc_html__('JavaScript API', 'mmp') ?></h2>
				<p>
					<?= esc_html__('Maps Marker Pro includes a JavaScript API, which can be utilized by developers to attach or listen to map events.', 'mmp') ?><br />
					<?= sprintf(esc_html__('For full documentation and usage examples, please visit %1$s.', 'mmp'), '<a href="https://www.mapsmarker.com/javascript-api/" target="_blank">https://www.mapsmarker.com/javascript-api/</a>') ?>
				</p>
				...
				<ul>
					...
					<li>- English (en_US)</li>
					<li>- Finnish (fi_FI) thanks to <a href="https://twitter.com/jessibjork" target="_blank">Jessi Björk</a></li>
					...
					<li>- Galician (gl_ES) thanks to <a href="http://www.indicepublicidad.com" target="_blank">Fernando Coello</a></li>
					<li>- German (de_DE)</li>
					<li>- Greek (el) thanks to <a href="http://www.mapdow.com" target="_blank">Philios Sazeides</a>, Evangelos Athanasiadis, <a href="http://avakon.com" target="_blank">Vardis Vavoulakis</a></li>
					<li>- Hebrew (he_IL) thanks to <a href="http://pluto2go.co.il" target="_blank">Alon Gilad</a>, kobi levi</li>
					<li>- Hindi (hi_IN) thanks to <a href="http://outshinesolutions.com" target="_blank">Outshine Solutions</a>, <a href="http://indlinux.org" target="_blank">Guntupalli Karunakar</a></li>
					...
					<li>- Norwegian/Bokmål (nb_NO) thanks to <a href="http://ingetang.com" target="_blank">Inge Tang</a></li>
					<li>- Polish (pl_PL) thanks to <a href="http://injit.pl" target="_blank">Pawel Wyszyński</a>, <a href="http://www.kochambieszczady.pl" target="_blank">Tomasz Rudnicki</a>, Robert Pawlak, <a href="http://mojelodzkie.pl" target="_blank">Daniel</a>, Paul Dworniak</li>
					...
					<li>- Pujabi (pa) thanks to <a href="https://www.janbasktraining.com" target="_blank">Vikas Arora</a></li>
					<li>- Romanian (ro_RO) thanks to <a href="http://administrare-cantine.ro" target="_blank">Arian</a>, <a href="http://www.inadcod.com" target="_blank">Daniel Codrea</a>, <a href="http://www.inboxtranslation.com" target="_blank">Flo Bejgu</a></li>
					...
					<li>- Spanish/Mexico (es_MX) thanks to <a href="http://1sistemas.net" target="_blank">Victor Guevera</a>, Eze Lazcano</li>
					...
					<li>- Turkish (tr_TR) thanks to <a href="http://www.karalamalar.net" target="_blank">Emre Erkan</a>, <a href="http://www.bozukpusula.com" target="_blank">Mahir Tosun</a></li>
				...
				<ul>
					...
					<li>- <a href="https://github.com/aratcliffe/Leaflet.contextmenu" target="_blank">Context menu plugin</a> by Adam Ratcliffe</li>
					<li>- <a href="https://github.com/geoman-io/leaflet-geoman" target="_blank">Geometry plugin</a> by Sumit Kumar</li>
					<li>- <a href="https://github.com/stefanpenner/es6-promise" target="_blank">Promise polyfill</a> by Yehuda Katz, Tom Dale, Stefan Penner and contributors</li>
					<li>- <a href="https://www.chartjs.org" target="_blank">Chart.js</a> by Chart.js Contributors</li>
					<li>- <a href="https://github.com/algolia/autocomplete.js" target="_blank">Autocomplete.js</a> by Algolia</li>
					...
					<li>- <a href="https://github.com/flatpickr/flatpickr" target="_blank">flatpickr</a> by Gregory Petrosyan</li>
					...
					<li>- Home icon by <a href="https://prothemedesign.com" target="_blank">Pro Theme Design</a></li>
				...
				<img src="<?= plugins_url('images/logo-mapsmarker-pro.svg', MMP::$path) ?>" />
			</div>
		</div>
		<?php
	}
