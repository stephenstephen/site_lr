...
class Effects26 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-general-style-26', OXI_IMAGE_HOVER_URL . '/Modules/General/Files/style-26.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
 public function default_render($style, $child, $admin) {
    ...
    public function old_render() {
        ...
        $new = [
            ...
            'image_hover_effects' => '',
            'oxi-image-hover-effects-time-size' => '1000',
