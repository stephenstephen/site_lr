...
class Effects32 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-general-style-32', OXI_IMAGE_HOVER_URL . '/Modules/General/Files/style-32.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
    ...
    public function old_render() {
        ...
        $new = [
            ...
            'oxi-image-hover-content-margin-lap-top' => ($styledata[29] + $styledata[25]),
            'oxi-image-hover-content-margin-lap-right' => ($styledata[29] + $styledata[25]),
            'oxi-image-hover-content-margin-lap-bottom' => ($styledata[29] + $styledata[25]),
            'oxi-image-hover-content-margin-lap-left' => ($styledata[29] + $styledata[25]),
            ...
            'oxi-image-hover-hover-boxshadow-shadow' => 'yes',
            'oxi-image-hover-hover-boxshadow-type' => '',
            'oxi-image-hover-hover-boxshadow-horizontal-size' => 0,
            'oxi-image-hover-hover-boxshadow-vertical-size' => 0,
            'oxi-image-hover-hover-boxshadow-blur-size' => 0,
            ...
            'oxi-image-hover-button-border-type' => 'solid',
            'oxi-image-hover-button-border-width-lap-top' => 2,
            'oxi-image-hover-button-border-width-lap-right' => 2,
            'oxi-image-hover-button-border-width-lap-bottom' => 2,
            'oxi-image-hover-button-border-width-lap-left' => 2,
            'oxi-image-hover-button-border-width-lap-choices' => 'px',
            'oxi-image-hover-button-border-color' => $styledata[59],
            'oxi-image-hover-button-hover-border-color' => $styledata[67],
            ///
