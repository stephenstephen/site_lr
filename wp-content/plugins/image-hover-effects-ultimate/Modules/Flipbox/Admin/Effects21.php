...
class Effects21 extends Modules {
    ...
    public function register_front_content_settings() {
        ...
        $this->add_responsive_control(
            ...
            'description' => 'Generate space ourside a Flipbox.',
                ]
        );
    ...
    public function register_front_number_settings() {
        ...
        $this->add_responsive_control(
            ...
            'description' => 'Allows you to Set Number Width Height.',
                ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            'description' => 'Allows you at hover to attaches one or more shadows into Number.',
                ]
        );
    ...
    public function register_back_content_settings() {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                ...
                . '{{WRAPPER}} .oxi-image-hover:hover .oxi-image-hover-figure-backend-section-body, '
                . '{{WRAPPER}} .oxi-image-hover.oxi-touch .oxi-image-hover-figure-backend-section-body, '
