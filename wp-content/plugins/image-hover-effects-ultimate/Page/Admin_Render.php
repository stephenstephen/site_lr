                                ...
                                <form method="post" id="oxi-addons-form-submit">
                                    <div class="oxi-addons-style-settings">
                                        ...
                                        <div class="oxi-addons-setting-save">
                                            ...
                                            <input type="hidden"  id="image-hover-preview-color" name="image-hover-preview-color" value="<?php echo(is_array($this->style) ? array_key_exists('image-hover-preview-color', $this->style) ? $this->style['image-hover-preview-color'] : '#FFF' : '#FFF'); ?>">
                                            <input type="hidden"  id="image-hover-style-id" name="image-hover-style-id" value="<?php echo $this->dbdata['id']; ?>">
                                            <input type="hidden"  id="image-hover-template" name="image-hover-template" value="<?php echo ucfirst($this->dbdata['style_name']); ?>">
