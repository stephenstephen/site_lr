...
class Effects25 extends Public_Render {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('oxi-image-hover-flipbox-style-25', OXI_IMAGE_HOVER_URL . '/Modules/Flipbox/Files/style-25.css', false, OXI_IMAGE_HOVER_PLUGIN_VERSION);
    }
...
//            endif;
            ...
            if ($value['image_hover_button_icon'] != '' && $this->url_render('image_hover_button_link', $value) != ''):
                $button = '<div class="oxi-image-hover-button ' . $this->style['oxi-image-flip-back-button-animation'] . ' ' . $this->style['oxi-image-flip-back-button-animation-delay'] . '">
                            <a ' . $this->url_render('image_hover_button_link', $value) . ' class="oxi-image-btn">' . $this->font_awesome_render($value['image_hover_button_icon']) . '</a>
                        </div>';
            ...
            echo '  <div class="oxi-image-hover-style ' . $this->column_render('oxi-image-hover-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '"  ' . $this->animation_render('oxi-image-hover-animation', $style) . '>
                        <div class="oxi-image-hover-style-flipbox">
                            ' . $hr . '
                                <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-25 oxi-image-flipbox-hover-' . $this->oxiid . '-' . $val['id'] . '">
